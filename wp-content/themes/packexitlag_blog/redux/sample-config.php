 ...
 */
    ...
    **********************************************/
        ...
        //SESSÃO PÁGINA DE POST
        Redux::setSection( $opt_name, array(
            'title'            => __( 'Configurações da home', 'redux-framework-demo' ),
            'id'               => 'configuracoes_home',
            'desc'             => __( '', 'redux-framework-demo' ),
            'customizer_width' => '400px',
            'icon'             => 'el el-website'
            ) 
            ...
            Redux::setSection( $opt_name, array(
                    'title'            => __( 'Frase box vermelho', 'redux-framework-demo' ),
                    'id'               => 'opt_box_vermelho',
                    'subsection'       => true,
                    'desc'             => __( '', 'redux-framework-demo' ),
                    'customizer_width' => '450px',
                    'fields'           => array(
                        array(
                            'id'       => 'opt_box_vermelho_titulo',
                            'type'     => 'text',
                            'title'    => __( 'Frase:', 'redux-framework-demo' ),
                            'desc'    =>  __( '', 'redux-framework-demo' ),
                        ),
                        array(
                            'id'       => 'opt_box_vermelho_tituloLink',
                            'type'     => 'text',
            ...
            Redux::setSection( $opt_name, array(
                    'title'            => __( 'Frase box vermelho EN', 'redux-framework-demo' ),
                    'id'               => 'opt_box_vermelho_en',
                    'subsection'       => true,
                    'desc'             => __( '', 'redux-framework-demo' ),
                    'customizer_width' => '450px',
                    'fields'           => array(
                        array(
                            'id'       => 'opt_box_vermelho_titulo_en',
                            'type'     => 'text',
                            'title'    => __( 'Frase:', 'redux-framework-demo' ),
                            'desc'    =>  __( '', 'redux-framework-demo' ),
                        ),
                        array(
                            'id'       => 'opt_box_vermelho_tituloLink_en',
                            'type'     => 'text',
                            'title'    => __( 'Link:', 'redux-framework-demo' ),
                            'desc'    =>  __( '', 'redux-framework-demo' ),
                        ),
